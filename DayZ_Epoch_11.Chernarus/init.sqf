...
call compile preprocessFileLineNumbers "custom\JAEM\variables.sqf";		// JAEM
...
fnc_usec_selfActions = compile preprocessFileLineNumbers "custom\take_clothes\fn_selfActions.sqf";             // custom self action
...
if (!isDedicated) then {
	...
	// custom kill message
	execVM "custom\kill_message\killmsg.sqf";
