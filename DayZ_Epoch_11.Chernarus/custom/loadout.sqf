...
if ((getPlayerUID player) in ["76561198099487051","76561198120776371"]) then {  //Helpers
	DefaultMagazines = ["ItemBandage","ItemBandage","ItemBandage","ItemMorphine","ItemPainkiller","17Rnd_9x19_glock17","17Rnd_9x19_glock17","30Rnd_556x45_StanagSD","30Rnd_556x45_StanagSD"];
	DefaultWeapons = ["glock17_EP1","ItemMap","ItemFlashlightRed","ItemHatchet","M4A1_AIM_SD_camo"];
