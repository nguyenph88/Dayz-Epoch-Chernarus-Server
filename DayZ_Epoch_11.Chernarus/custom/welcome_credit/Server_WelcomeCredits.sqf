...
_role1 = "Welcome to";
_role1names = ["Survive Th3 Dead PVE Server", "Dayz Overpoch Chernarus"];
_role2 = "Rules";
_role2names = ["Newbies/New Players Only", "No PVP and stealing", "No Hack-Cheat-Script-DDOS anytime"];
