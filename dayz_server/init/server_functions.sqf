...
// customize the maps
call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\3cities.sqf";
call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\krasno.sqf";
